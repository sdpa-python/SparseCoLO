function [QMat0,cVect0,J,K0] = addUbd(QMat0,cVect0,lbd,ubd,J0,K0); 
...
for i = 1:K0.s-1
    ...
    oneCoefMat(1,1) = ubd(i); 
    QMatUbound = [QMatUbound; reshape(oneCoefMat,1,K0.s*K0.s)]; 
end
J.l = J.l + K0.s-1; 

QMat0 = [QMat0Free; QMatUbound; QMat0]; 
