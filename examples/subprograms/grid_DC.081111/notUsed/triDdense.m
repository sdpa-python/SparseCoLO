%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [QMat0,cVect0,lbd,ubd,K0,L0] = triDdense(sDim,nDim,randSeed,fileSaveSW); 
...
for i=1:nDim
    for j= 1:nDim
        if i==j 
            ...
            oneCoefMat = oneCoefMat + oneCoefMat' - ones(K0.s,K0.s);
            oneCoefMat(1,1) = 1; 
            % <---
...
if fileSaveSW == 1
    fileName = strcat('triDdense_',num2str(sDim),'_',num2str(nDim),'.mat'); 
